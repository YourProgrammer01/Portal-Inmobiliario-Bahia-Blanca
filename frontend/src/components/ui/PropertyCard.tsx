  ...
  return (
    <div className="card hover:shadow-md transition-shadow duration-200 flex flex-col">
      ...
      <div className="p-4 flex flex-col flex-1 gap-3">
        ...
        {/* Título */}
        <Link to={`/propiedad/${property.id}`} className="hover:text-primary-600 transition-colors">
        ...
        <div className="flex items-center gap-4 text-gray-600 text-sm">
          {property.bedrooms != null && (
            <span className="flex items-center gap-1">
              <Bed size={14} /> {property.bedrooms} dorm.
            </span>
          )}
          ...
          {property.squareMeters != null && (
            <span className="flex items-center gap-1">
              <Maximize size={14} /> {property.squareMeters} m²
            </span>
          )}
        </div>
